...
export async function addEndpoint(name, url, key, authMode, transformer, model, remark, requestOverrides) {
    await window.go.main.App.AddEndpoint(name, url, key, authMode, transformer, model, remark || '', requestOverrides || '');
}

export async function updateEndpoint(index, name, url, key, authMode, transformer, model, remark, requestOverrides) {
    await window.go.main.App.UpdateEndpoint(index, name, url, key, authMode, transformer, model, remark || '', requestOverrides || '');
}

export default {
    ...
    modal: {
        ...
        modelHelpCli: '指定要使用的 Claude CLI 模型',
    ...
    traffic: {
        title: '流量日志',
        subtitle: '查看最近代理请求的原始/转换前后请求与响应内容。',
        loading: '正在加载流量日志...',
        summary: '当前显示 {count} 条，共缓存 {total} 条',
        empty: '还没有流量日志。先开启记录并发送一次请求。',
        refresh: '刷新',
        refreshed: '流量日志已刷新',
        refreshFailed: '刷新流量日志失败',
        clear: '清空',
        clearConfirm: '确认清空当前缓存的流量日志吗？',
        cleared: '流量日志已清空',
        clearFailed: '清空流量日志失败',
        recording: '记录中',
        recordingEnabled: '已开启流量记录',
        recordingDisabled: '已关闭流量记录',
        recordingToggleFailed: '更新流量记录状态失败',
        endpointPlaceholder: '按端点名称筛选',
        allFormats: '全部格式',
        allResults: '全部结果',
        onlyErrors: '仅错误',
        onlySuccess: '仅成功',
        ...
        originalResponse: '原始响应 / SSE',
        transformedResponse: '转换后响应 / SSE'
    },
    test: {
        title: '测试结果',
        testing: '测试中...',
    ...
    settings: {
        ...
        augment: {
            title: 'Augment',
            enabled: '启用桌面端 Augment 桥接',
            port: '端口',
            help: '仅桌面端使用。修改后需要重启桌面应用生效。'
        },

export default {
    ...
    modal: {
        ...
        modelHelpCli: 'Specify the Claude CLI model to use',
    ...
    traffic: {
        title: 'Traffic',
        subtitle: 'Inspect raw and transformed requests and responses from the latest proxy calls.',
        loading: 'Loading traffic logs...',
        summary: 'Showing {count} of {total} buffered entries',
        empty: 'No traffic logs yet. Enable recording and send a request first.',
        refresh: 'Refresh',
        refreshed: 'Traffic logs refreshed',
        refreshFailed: 'Failed to refresh traffic logs',
        clear: 'Clear',
        clearConfirm: 'Clear all buffered traffic logs?',
        cleared: 'Traffic logs cleared',
        clearFailed: 'Failed to clear traffic logs',
        recording: 'Recording',
        recordingEnabled: 'Traffic recording enabled',
        recordingDisabled: 'Traffic recording disabled',
        recordingToggleFailed: 'Failed to update traffic recording',
        endpointPlaceholder: 'Filter by endpoint name',
        allFormats: 'All formats',
        allResults: 'All results',
        onlyErrors: 'Only errors',
        onlySuccess: 'Only success',
        time: 'Time',
        endpoint: 'Endpoint',
        client: 'Client',
        event: 'Event',
        ...
        actions: 'Actions',
        inspect: 'Inspect',
        detailTitle: 'Traffic Detail',
        detailLoadFailed: 'Failed to load traffic detail',
        ...
        originalResponse: 'Original Response / SSE',
        transformedResponse: 'Transformed Response / SSE'
    },
    test: {
        title: 'Test Result',
        testing: 'Testing...',
    ...
    settings: {
        ...
        augment: {
            title: 'Augment',
            enabled: 'Enable desktop Augment bridge',
            port: 'Port',
            help: 'Desktop only. Changes require restarting the desktop app.'
        },

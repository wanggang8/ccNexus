// SVG Icon System for ccNexus
// Minimal, consistent, and scalable icons
...
export const icons = {
  ...
  settings: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6m5.2-14.2l-4.2 4.2m-2 2l-4.2 4.2M23 12h-6m-6 0H1m14.2 5.2l-4.2-4.2m-2-2l-4.2-4.2"/></svg>`,
  ...
  flask: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3h6m-5 0v6.5L4 18a1 1 0 0 0 .87 1.5h14.26A1 1 0 0 0 20 18l-6-8.5V3"/></svg>`,

  fileEdit: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20h4l10.5-10.5a1.414 1.414 0 0 0-2-2L6 18v2z"/><path d="M13.5 6.5l2 2"/></svg>`,
  ...
  wave: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18.97 3.66a2.25 2.25 0 0 1 .62 3.12L12.3 17.2a7.5 7.5 0 0 1-12-5.7l.1-.4 1.8-5.4a2.25 2.25 0 0 1 4.26 1.42L5.1 11.4a4.5 4.5 0 0 0 7.2 3.42l7.28-10.54a2.25 2.25 0 0 1 3.12-.62z"/></svg>`,

  satellite: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 7L9 3 5 7l4 4"/><path d="M17 11l4 4-4 4-4-4"/><path d="m8 12 4 4"/><path d="m12 8 4 4"/><path d="M2 22l4-4"/><circle cx="18" cy="6" r="3"/></svg>`,
